      ...
      <div className="flex flex-col gap-6">
        ...
        {!isShopConnected && (
          <div className="bg-zinc-900 border border-[#F1641E]/40 rounded-xl p-6 text-center shadow-lg space-y-4">
            ...
            <div>
              <h3 className="font-bold text-white text-lg">Ma─ƒazan─▒z Ba─ƒl─▒ De─ƒil</h3>
              <p className="text-zinc-400 text-sm mt-1">
                Eklentinin t├╝m istatistiklerini, zaman ├ºizelgesini, k├ór hesaplay─▒c─▒s─▒n─▒ ve yapay zeka analizlerini kullanabilmek i├ºin Etsy ma─ƒazan─▒z─▒ ba─ƒlaman─▒z gerekmektedir. ┼₧imdilik sadece etiketleri g├╢rebilirsiniz.
              </p>
            </div>
            <button 
              onClick={() => {
        ...
        <div className="bg-zinc-950/20 border border-zinc-800 rounded-xl p-6 space-y-4">
          ...
          <div className="bg-zinc-900/50 p-4 rounded-lg border border-zinc-800">
            <p className="text-sm text-zinc-300 italic">
              "Al─▒c─▒lar─▒n %80'i kargonun yava┼ƒl─▒─ƒ─▒ndan ┼ƒikayet etmi┼ƒ. Herkes ├╝r├╝n├╝n renginin foto─ƒraftakinden daha canl─▒ oldu─ƒunu s├╢yl├╝yor."
            </p>
          </div>
        </div>
