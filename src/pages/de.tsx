  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="p-4 bg-[#0d0d0d] border border-zinc-800 rounded-xl space-y-3 text-xs shadow-sm">
          ...
          <div className="bg-[#0d0d0d] border border-zinc-800 rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800/50">
                <div className="flex items-center gap-2 text-emerald-400 mb-1">
                  ...
                  <span className="font-semibold text-lg">{views !== undefined ? views.toLocaleString() : 'N/A'}</span>
                </div>
              ...
              <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800/50">
                <div className="flex items-center gap-2 text-emerald-400/70 mb-1">
                  ...
                  <span className="font-semibold text-lg">{estMonthlyViews !== null ? estMonthlyViews.toLocaleString() : 'N/A'}</span>
                </div>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Est. Monthly Views</p>
              </div>
              <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800/50">
                <div className="flex items-center gap-2 text-rose-400 mb-1">
                  <Heart className="w-4 h-4" />
                  <span className="font-semibold text-lg">{num_favorers !== undefined ? num_favorers.toLocaleString() : 'N/A'}</span>
                </div>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Total Favorites</p>
              </div>
              <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800/50">
                <div className="flex items-center gap-2 text-rose-400/70 mb-1">
                  <Heart className="w-4 h-4" />
                  <span className="font-semibold text-lg">{estMonthlyFavorites !== null ? estMonthlyFavorites.toLocaleString() : 'N/A'}</span>
                </div>
                <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Est. Monthly Favs</p>
              </div>
              <div className="bg-zinc-900/50 rounded-lg p-4 border border-zinc-800/50">
            ...
            <Link 
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[#F1641E] hover:bg-[#d95a1a] text-white rounded-lg text-sm font-bold uppercase tracking-wider shadow-md transition-colors mb-3"
            >
