    ...
    <div className="min-h-screen bg-[#121212] text-[#F5F5F5] p-6 space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
        <div>
          <h1 className="text-2xl font-extrabold tracking-tight text-white flex items-center gap-2">
            Seller Dashboard
            <div className="px-2 py-0.5 bg-emerald-500/20 text-emerald-400 text-[10px] uppercase tracking-widest rounded-full font-bold">Active</div>
          </h1>
          <p className="text-xs text-zinc-500 mt-1">Monitor your shop's performance and AI insights here.</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-zinc-950/40 border border-zinc-800/80 rounded-xl p-4 flex flex-col hover:border-indigo-500/30 transition-colors group">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold block">Monthly Visits</span>
        ...
        <div className="bg-zinc-950/40 border border-zinc-800/80 rounded-xl p-4 flex flex-col hover:border-emerald-500/30 transition-colors group">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold block">Monthly Revenue</span>
        ...
        <div className="bg-zinc-950/40 border border-zinc-800/80 rounded-xl p-4 flex flex-col hover:border-amber-500/30 transition-colors group">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold block">Active Listings</span>
            <Package className="w-4 h-4 text-amber-400 opacity-70 group-hover:opacity-100 transition-opacity" />
          </div>
          <div className="flex items-end gap-2">
            <span className="text-2xl font-bold text-white">42</span>
            <span className="text-xs font-semibold text-zinc-500 flex items-center mb-1">items</span>
          </div>
        </div>
        ...
        <div className="bg-zinc-950/40 border border-zinc-800/80 rounded-xl p-4 flex flex-col hover:border-[#F1641E]/30 transition-colors group">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold block">Conversion</span>
      ...
      <div className="bg-gradient-to-br from-indigo-900/40 via-purple-900/20 to-[#121212] border border-indigo-500/30 rounded-xl p-6 relative overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-white">AI Shop Assistant</h2>
            <p className="text-[11px] text-zinc-400 font-medium">Automatic opportunity detection</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="bg-zinc-950/60 border border-zinc-800 rounded-lg p-3 hover:bg-zinc-900/80 transition-colors cursor-pointer group flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-zinc-200 group-hover:text-white transition-colors">Winter Season Starting</p>
              <p className="text-xs text-zinc-500 mt-1 line-clamp-2">Items tagged with "Winter", "Cozy", "Gift" are expected to see a 20% boost. Consider highlighting your top 3 listings.</p>
            </div>
          ...
          <div className="bg-zinc-950/60 border border-zinc-800 rounded-lg p-3 hover:bg-zinc-900/80 transition-colors cursor-pointer group flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-zinc-200 group-hover:text-white transition-colors">Competitor Analysis: Excellent</p>
              <p className="text-xs text-zinc-500 mt-1 line-clamp-2">Your pricing strategy is converting 80% better than your competitors. No price changes recommended.</p>
            </div>
      ...
      <div className="flex flex-col gap-3 pb-8">
        <button className="flex items-center justify-between p-4 bg-zinc-950/40 border border-zinc-800 rounded-xl hover:bg-zinc-900 transition-colors group">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-sm text-zinc-300 group-hover:text-white transition-colors">Bulk Listing Update</span>
          </div>
