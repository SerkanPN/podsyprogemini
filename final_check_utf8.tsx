            ...
            <div className="border-t border-zinc-200">
              ...
              <div className="pb-4">
                ...
                <ul className="space-y-2 mb-4 text-sm">
                  <li className="flex gap-2"><span className="shrink-0">Γ£¿</span> Designed by <span className="font-bold">UpTopNorth</span></li>
                  <li className="flex gap-2"><span className="shrink-0">≡ƒôª</span> Materials: comfort colors, fast shipping</li>
                </ul>
            ...
            <div className="border-t border-b border-zinc-200">
              ...
              <div className="pb-4 space-y-4 text-sm">
                <div className="flex gap-3">
                  <span className="font-bold shrink-0">≡ƒôà</span>
                  <div>
                    <p>Order today to get by <span className="font-bold underline">Jul 30-Aug 6</span></p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <span className="font-bold shrink-0">≡ƒôª</span>
                  <div>
                ...
                <div className="flex gap-3">
                  <span className="font-bold shrink-0">≡ƒÜÜ</span>
                  <div>
